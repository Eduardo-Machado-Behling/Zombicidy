package main.frontend.terminal;
...
public class Terminal {
    ...
    public void Combat( Combat combat ) {
        ...
        while ( combatBool ) {
            ...
            System.out.println(" 1: Attack Hand | 2: Shoot | 3:Use Bandage | 4: Run ");
    ...
    public void  SurpriseEncounter() {
        System.out.println("Surprise Encounter");
    }
    ...
    public void GainedItem( String item ) {
        System.out.println( "Gained " + item );
    }
